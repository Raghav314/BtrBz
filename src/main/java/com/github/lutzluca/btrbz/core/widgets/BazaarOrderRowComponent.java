...
final class BazaarOrderRowComponent extends BaseUIComponent {
    ...
    static PriorityWidths priorityWidths(int availableWidth, int prefixWidth, int rightWidth) {
    ...
    record PriorityWidths(int prefixWidth, int rightWidth) {}

    record BazaarRow(String id, String prefix, int prefixColor, String text, String rightText, int rightColor,
                       int statusColor, List<Component> tooltip, Consumer<Boolean> clickAction,
                       boolean preservePrefix, int backgroundColor) {
        BazaarRow(String id, String prefix, int prefixColor, String text, String rightText, int rightColor,
                    int statusColor, List<Component> tooltip, Consumer<Boolean> clickAction) {
