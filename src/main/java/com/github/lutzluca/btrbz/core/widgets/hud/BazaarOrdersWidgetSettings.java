...
public final class BazaarOrdersWidgetSettings {
    ...
    public static UIComponent create(WidgetConfigBinding<BazaarOrdersWidgetConfig> binding) {
        ...
        integer(panel, "Visible orders", binding, c -> c.visibleOrders, (c, v) -> c.visibleOrders = v, 1, 10);
        ...
        enumeration(panel, "Undercut detail", binding, c -> c.undercutDetail, (c, v) -> c.undercutDetail = v);
        return panel;
    }
}
