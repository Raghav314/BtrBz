...
import com.github.lutzluca.btrbz.core.widgets.WidgetsConfig.BookmarkedItem;
...
public final class BookmarkComponent {
    ...
    public BookmarkComponent(
        ...
        trackedOrders.addOnOrderAddedListener(ignored -> this.rebuildOrderCache());
        trackedOrders.addOnOrderRemovedListener(ignored -> this.rebuildOrderCache());
        trackedOrders.addOnOrderUpdatedListener(ignored -> this.rebuildOrderCache());
