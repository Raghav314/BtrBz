...
final class BazaarUi {
    private BazaarUi() {}

    static FlowLayout panel(int width) {
    ...
    static FlowLayout line(UIComponent... components) {
    ...
    static LabelComponent text(String value, int color) { return label(value, color); }

    static LabelComponent boldLabel(String value, int color) {
    ...
    static ItemComponent icon(ItemStack stack) { return item(stack, 16); }

    static ItemComponent item(ItemStack stack, int size) {
    ...
    static FormattedCharSequence ellipsize(Component text, int maxWidth) {
